...
function Menu() {
  ...
  useEffect(() => {
    ...
    Papa.parse(
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vT3_Y4S07lEAOcGMG2zomrS61YwFsh6D86uyDrkj_UMEbDHN7iiKsl_a-_Gqy-csw_fsMkBApoqTIxw/pub?gid=0&single=true&output=csv",
      {
        download: true,
        header: true,
        complete: (results) => {
